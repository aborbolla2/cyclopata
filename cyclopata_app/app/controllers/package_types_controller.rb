  ...
  def create
    ...
    respond_to do |format|
      if @package_type.save
        format.html { redirect_to package_types_path, notice: 'Package type was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @package_type.update(package_type_params)
        format.html { redirect_to package_types_path, notice: 'Package type was successfully updated.' }
